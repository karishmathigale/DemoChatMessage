...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinxLibraryAccessors extends SubDependencyFactory {
        private final KotlinxTestLibraryAccessors laccForKotlinxTestLibraryAccessors = new KotlinxTestLibraryAccessors(owner);

        public KotlinxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>kotlinx.test</b>
         */
        public KotlinxTestLibraryAccessors getTest() {
            return laccForKotlinxTestLibraryAccessors;
        }

    }

    public static class KotlinxTestLibraryAccessors extends SubDependencyFactory {

        public KotlinxTestLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutine() {
            return create("kotlinx.test.coroutine");
        }
